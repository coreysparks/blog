...
![](C:/Users/ozd504/Documents/Github/blog/_knitr/map1.png)
...
mv2= mapview(mean_feature, col.regions="red")+mapview( results)
mapshot(mv2, file = paste0(getwd(), "/map2.png"))

```

![](C:/Users/ozd504/Documents/Github/blog/_knitr/map2.png)
...
mv3 = mapview(median_feature, col.regions="green")+
  mapview(mean_feature, col.regions="red")+
  mapview( results)
mapshot(mv3, file = paste0(getwd(), "/map3.png"))

```

![](C:/Users/ozd504/Documents/Github/blog/_knitr/map3.png)

## Buffer points
```{r}
wicbuff<- st_buffer(results.proj, dist = 2500)
mv4 = mapview(wicbuff)+mapview(results.proj, col.regions="green")
mapshot(mv4, file = paste0(getwd(), "/map4.png"))

```
![](C:/Users/ozd504/Documents/Github/blog/_knitr/map4.png)
...
mapshot(mv5, file = paste0(getwd(), "/map5.png"))
...
mv6 = mapview(result)+mapview(results.proj)
mapshot(mv6, file = paste0(getwd(), "/map6.png"))

```
![](C:/Users/ozd504/Documents/Github/blog/_knitr/map6.png)
...
mv7 = mapview(spjoin["punemp"])+mapview(sa_trol)
mapshot(mv7, file = paste0(getwd(), "/map7.png"))
```
![](C:/Users/ozd504/Documents/Github/blog/_knitr/map7.png)
...
mv8 = mapview(sa_acs2, zcol="nwic")+
  mapview(results.proj, col.regions = "green")

 mapshot(mv8, file = paste0(getwd(), "/map8.png"))
```

![](C:/Users/ozd504/Documents/Github/blog/_knitr/map8.png)
...
mv9 = mapview(wic_von, alpha=.75)+
  mapview(results.proj, col.regions="green")
 mapshot(mv9, file = paste0(getwd(), "/map9.png"))
```
![](C:/Users/ozd504/Documents/Github/blog/_knitr/map9.png)
